  ...
  return (
    <CenterItems>
      <div className='flex flex-col items-center justify-center text-center lg:min-w-lgshadow-xl rounded-2xl p-10 gap-4'>
        <div className='text-6xl text-yellow-500 animate-pulse'>{icon}</div>
        ...
        <Link href={navigateTo}>
          <button className='mt-4 px-6 py-3 bg-gray-900 text-gray-100 text-lg font-medium rounded-lg shadow hover:bg-gray-700 transition-colors cursor-pointer'>
            {buttonText}
          </button>
        </Link>
      </div>
