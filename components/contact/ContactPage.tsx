      ...
      <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        <div className='space-y-6'>
          ...
          <p className='text-stone-700 leading-relaxed'>
            Hi there! 👋 I’m Phil, the creator behind Convert Like A Pro. I love
            hearing from users, fellow developers, and curious minds.
          </p>
          <p className='text-stone-700 leading-relaxed'>
            Got a cool idea, feedback, or spotted something quirky? 💭 Don’t be
            shy — your thoughts help me make this tool even better.
          </p>
          <p className='text-stone-700 leading-relaxed'>
